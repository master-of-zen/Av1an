...
pub fn write_scenes_to_file(
    ...
    let data = ScenesData {
        scenes: scenes.to_vec(), frames: total_frames
    };
...
pub fn read_scenes_from_file(
    ...
    let data: ScenesData =
        serde_json::from_reader(reader).with_context(|| {
            format!(
                "Failed to parse scenes file {scene_path:?}, this likely \
                 means that the scenes file is corrupted"
            )
        })?;
...
mod tests {
    ...
    fn test_extra_split_segments() {
        ...
        let expected_split_locations = [
            0usize, 75, 150, 253, 356, 460, 549, 638, 728, 822, 876, 890, 995,
            1100, 1199, 1299, 1399, 1502, 1605, 1709, 1806, 1903,
        ];
    ...
    fn test_extra_split_preserves_zone_overrides() {
        ...
        let expected_split_locations = [
            0, 75, 150, 253, 356, 460, 504, 549, 594, 638, 683, 728, 822, 876,
            890, 995, 1100, 1199, 1299, 1399, 1502, 1605, 1709, 1806, 1903,
        ];
