...
class Ui_Av1an_main_windows(object):
    def setupUi(self, Av1an_main_windows):
        ...
        sizePolicy.setHeightForWidth(Av1an_main_windows.sizePolicy().hasHeightForWidth())
        ...
        self.DropInLabel.setStyleSheet("            QLabel{\n"
"\n"
...
"            }")
    ...
    def retranslateUi(self, Av1an_main_windows):
        ...
        Av1an_main_windows.setWindowTitle(_translate("Av1an_main_windows", "MainWindow"))
        self.Input_Button.setText(_translate("Av1an_main_windows", "Input"))
        self.Video_Settings_Button.setText(_translate("Av1an_main_windows", "Generic Settings"))
        ...
        self.DropInLabel.setText(_translate("Av1an_main_windows", "Drop In File Or Click For Import"))
