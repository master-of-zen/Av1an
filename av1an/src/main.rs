...
pub struct CliOpts {
  ...
  /// which means to get the same quality you must also usually lower the --target-quality. Since going higher than
  /// n=4 usually results in unusable scores, higher values are silently changed to 1.
